...
*/
	...
	if (isset($_POST['change_password'])) {
		$error = tep_validate_change_password($_SESSION['learner']->username, $_POST['old_password'], $_POST['new_password'], $_POST['confirm_password']);
		if (!$error) {
			$sql_array = array("password" => md5($_POST['new_password']));
			$username = $_SESSION['learner']->username;
