...
<p style="margin-top:20px;">This form is used to create new product category.</p>
 ...
 <table width="100%" border="0" align="center" cellpadding="5" cellspacing="1" class="entryTable">
  ...
  <tr> 
   ...
   <td class="content"> <select name="txtCname">
   	<option value="Slow Consume">Slow Consume</option>
	<option value="Fast Consume">Fast Consume</option>
   </select>
   </td>
  </tr>
  <tr> 
