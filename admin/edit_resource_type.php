...
*/
	...
	if (isset($_POST['edit_rt']) && tep_validate_entry($_POST['name'])) {
		//make entry into centers
		if (tep_validate_user($_SESSION['admin_user'], $access_level)) {
			$sql_array = array("name" => $_POST['name']);
			tep_db_perform(TABLE_RESOURCE_TYPE, $sql_array, 'update', "id = '$resource_type_id'");
			
			header("Location: add_resource_type.php");
						...
						<td>
							...
							<tr>
								<td align="left">
									...
									<h4>Edit Resource Type</h4>
									<form action="edit_resource_type.php?id=<?php echo $resource_type_id; ?>" name="add_rt" method="POST">
									<table width="100%">
										<tr>
											...
											<td class="right">
												<input name="name" type="text" class="textbox1" value="<?php echo tep_get_name(TABLE_RESOURCE_TYPE, $resource_type_id); ?>">
											</td>
										</tr>
										<tr>
											<td colspan="2">&nbsp;
										...
										<tr>
											<td colspan="2" align="center">
												<input name="edit_rt" type="submit" value="Edit Resource Type" class="submit3">
											</td>
										</tr>
									</table>
									</form>
