	...
	if (isset($_POST['dates'])) {
		...
		else
		{
			//we need to make entries into the calendar table
				$sql_array = array("start_date" => $_POST['selected_date'][0],
...
?>
	<TABLE width=<?php echo TABLE_WIDTH; ?> cellspacing="0" cellpadding="0" border="0" align="center" bgcolor="#ffffff">
		...
		<tr>
			...
			<td height="18" class="subtitle" valign="bottom" width="12%">Edit Date Selection</td>
					...
					<tr>
						<td>
							<table width='100%'>
								...
								<form name="dates" action="edit_select_dates.php?id=<?php echo $_GET['id']; ?>" method="post">
								<tr>
									...
									if ($counter == 0) {
										for ($month=date('n'); $month <= 12; $month++) {
											...
											if ($counter % 2 == 0) { ?>
												<tr>
													<td align="center">
														<?php echo tep_generate_calendar($year, $month, $scheduled->dates); ?>
													</td>
											<?php
											}
											else
