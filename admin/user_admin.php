...
?>
	...
	<TABLE width=<?php echo TABLE_WIDTH; ?> cellspacing="0" cellpadding="0" border="0" align="center" bgcolor="#ffffff">
		...
		<tr>
			...
			<td height="18" class="subtitle" valign="bottom" width="12%">Create and Alter Profiles</td>
			...
			<td align="middle">
				...
				<table width=<?php echo SEC_TABLE_WIDTH; ?> align="center" cellspacing="1" cellpadding="3">
					<tr>
						...
						<td class="right" width="97%" id="sectionLinks"><a href="add_user.php">Add User</a></td>
					</tr>
					<tr>
						<td align="right" class="left" width="4px" valign="middle">*</td>
						<td class="right" width="97%" id="sectionLinks"><a href="view_users.php">View Users</a></td>
					</tr>
					<tr>
						<td align="right" class="left" width="4px" valign="middle">*</td>
						<td class="right" width="97%" id="sectionLinks"><a href="add_instructor_group.php">Instructor Groups</a></td>
					</tr>
					<tr>
						<td align="right" class="left" width="4px" valign="middle">*</td>
						<td class="right" width="97%" id="sectionLinks"><a href="email_domains.php">Limit User Domains</a></td>
					</tr>
